...
public class SkullCreator {
    ...
    /**
     * Apply a player skull with base64 skin
     *
     * @param item   The ItemStack to apply the base64 onto. Must be a player skull.
     * @param base64 The Base64 string.
     * @return The head of the Player.
     */
    public static ItemStack applyTexture(ItemStack item, String base64) {
